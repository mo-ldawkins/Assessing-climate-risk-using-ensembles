...
nyears = round(netcdf_file.dimensions['time'].size/360)
...
bias_eai['bias'] = bias_eai['annual_impact_x'] - bias_eai['annual_impact_y']
...
ax3.set_xlabel('Spatially aggregated EAI \n (No. of days of work lost)')
ax3.set_ylabel('Frequency')
ax3.set_xlim(1.6e7,1.75e7)
...
cp = ax4.scatter(bias_eai['exposure_longitude'],bias_eai['exposure_latitude'],c=bias_eai['bias'],vmin=-1500,vmax=1500,s=12,cmap='bwr')
cbar = plt.colorbar(cp,ax=ax4,shrink=0.8)
cbar.set_label('Bias (No. of days of work lost)')
ax4.title.set_text('(d)')
ax4.coastlines()
...
ax3.set_xlabel('Spatially aggregated EAI \n (No. of days of work lost)')
ax3.set_ylabel('Frequency')
ax3.set_xlim(1e7,6e7)
ax3.hist(spaceagg['annual_impact'],density=False,color='cornflowerblue',label='Current climate (recent past)')
ax3.hist(spaceagg_2deg['annual_impact'],density=False,color='palegreen',label='2oC warming level')
ax3.hist(spaceagg_4deg['annual_impact'],density=False,color='darksalmon',label='4oC warming level')
...
# Figures 5 and 6 are made in R - code can be provided on request

######################################################################################################################
# Fig 7 - the new improved version of Fig 4
...
ax7.set_xlabel('Spatially aggregated EAI \n (No. of days of work lost)')
ax7.set_ylabel('Frequency')
ax7.set_xlim(1e7,6e7)
ax7.hist(spaceagg['sim_annual_impact'],density=False,color='cornflowerblue',label='Current climate (recent past)')
ax7.hist(spaceagg_2deg['sim_annual_impact'],density=False,color='palegreen',label='2oC warming level')
ax7.hist(spaceagg_4deg['sim_annual_impact'],density=False,color='darksalmon',label='4oC warming level')
ax7.legend(loc='upper right')
ax7.title.set_text('(g)')

plt.tight_layout()
plt.savefig(
       home_dir + 'Figure7_pA.png', dpi=500)
plt.show(block=True)